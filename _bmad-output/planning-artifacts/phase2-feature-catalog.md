...
| Q1.6 | **Capex vs. D&A** (maintenance starvation). Several years of capex < D&A inflates FCF now and is paid for later; a reverse DCF on starved FCF flatters the stock. | capex (mapped, Epic 6), `DepreciationDepletionAndAmortization`; IFRS `DepreciationAndAmortisationExpense` | 9/9 | **CP**, SU (asset-heavy) | Epic 6 already stores capex. Cheapest item in the catalog. | ≤1 | no |
